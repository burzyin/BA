...
public class GuideActivity extends CommonActivity implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (id > 0) {
            ...
            Toast.makeText(applicationContext, "Can't find guide in database", Toast.LENGTH_SHORT).show();
        }
    ...
    private class HtmlFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            RelativeLayout guideInfo = (RelativeLayout) inflater.inflate(R.layout.guide_text_layout, null, false);
            assert guideInfo != null;
            TextView description = (TextView) guideInfo.findViewById(R.id.guide_info);
    ...
    public void previousButtonProcess(View view) throws IOException {
    ...
    @SuppressWarnings("UnusedParameters")
    public void nextButtonProcess(View view) throws IOException {
        mCurrentAudioIndex = (mCurrentAudioIndex + 1) % mAudioList.size();
        highlightCurrentAudio();
        updateFragment();
        playAudio(mCurrentAudioIndex);
